...
public class ProdutoFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(ProdutoConsultaController.produto!=null){
            tfId.setText(""+ProdutoConsultaController.produto.getId());
            cbCategoria.setValue(ProdutoConsultaController.produto.getCategoria());
            tfPreco.setText(""+ProdutoConsultaController.produto.getPreco());
            tfNome.setText(ProdutoConsultaController.produto.getNome());
            tfDescricao.setText(ProdutoConsultaController.produto.getDescr());
            cbUnidade.setValue(ProdutoConsultaController.produto.getUnidade());
            isAlterar=true;
        }
    ...
    void onConfirmar(ActionEvent event) {
        ...
        Produto produto= new Produto(Integer.parseInt(tfId.getText()),tfNome.getText(),Double.parseDouble(tfPreco.getText()),tfDescricao.getText(),categoria,unidade);
        if (isAlterar){
